  ...
  const defaultPlans = [
    {
      ...
      price: "$1850",
      duration: "One time",
      features: ["Up to 10 pages", "1-2 forms", "Dynamic elements"],
    },

    {
      ...
      price: "$4850",
      duration: "One time",
      features: ["Up to 30 pages", "3-5 forms", "Dynamic elements","Rich media","Complex navigation"],
      featured: true
    },
...

    {
      ...
      price: "$9850",
      duration: "One time",
      features: ["Up to 10 pages", "Logins/paywall","Search & filter results","Restricted access" ,"Dynamic elements","Complex forms","Dynamic templates"],
    },

    {
      ...
      price: "Custom",
      duration: "One time",
      features: ["Anything and Everything you ask for","Unlimited pages","Logins/paywall","Complex forms","Dynamic templates","Search & facets"],
    },
